# -*- coding: utf-8 -*-
"""
Created on Sun May 24 16:38:27 2020
...
for k in range(0,N):
    st = X[:,k]
    con = U[:,k]
    st_next = f_esn(con) # This function gives us the right hand side. Should use ESNcasadi class 
    X[:,k+1] = st_next
...
while(mpciter < sim_tim / T):
    ...
    objfunc_val[mpciter] = sol['f'].full()
